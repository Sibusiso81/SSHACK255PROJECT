...
export const translations = {
  "Select your interests:": {
    ...
    IsiZulu: "Khetha izintshisekelo zakho:",
    Siswati: "Khetsa tintfo letikutsandzako:",
    isiXhosa: "Khetha izinto ozithandayo:",
    Setswana: "Kgetha dikgatlhego tsa gago:",
    Sepedi: "Kgetha dithahasello tša gago:",
    Sesotho: "Khetha lithahasello tsa hau:",
    Xitsonga: "Hlawula leswi ku tsakisaka:",
    Tshivenḓa: "Khetha zwine wa zwi funa:",
    Afrikaans: "Kies jou belangstellings:",
    IsiNdebele: "Khetha izinto ozithandayo:",
  },
  "Continue to dashboard": {
    English: "Continue to dashboard",
    IsiZulu: "Qhubeka kudeshibhodi",
    Siswati: "Qhubeka kuya kudeshibhodi",
    isiXhosa: "Qhubeka kwi-dashboard",
    Setswana: "Tswelela go dashboard",
    Sepedi: "Tšwela pele go dashboard",
    Sesotho: "Tsoela pele ho dashboard",
    Xitsonga: "Tshama emahlweni eka dashboard",
    Tshivenḓa: "Tshimbila u ya kha dashboard",
    Afrikaans: "Gaan voort na dashboard",
    IsiNdebele: "Qhubeka kudeshibhodi",
  },
  "Building your personalized dashboard...": {
    English: "Building your personalized dashboard...",
    IsiZulu: "Sakha ideshibhodi yakho eyenziwe ngokwezifiso...",
    Siswati: "Sakha ideshibhodi yakho leyakhelwe wena...",
    isiXhosa: "Sakha i-dashboard yakho eyenziwe ngokwezifiso...",
    Setswana: "Re aga dashboard ya gago e e ikgethileng...",
    Sepedi: "Re aga dashboard ya gago ya go ikgetha...",
    Sesotho: "Re haha dashboard ea hau e ikhethileng...",
    Xitsonga: "Hi aka dashboard ya wena yo hlawuleka...",
    Tshivenḓa: "Ri khou fhaṱa dashboard yau ya u tou khethea...",
    Afrikaans: "Bou jou persoonlike dashboard...",
    IsiNdebele: "Sakha ideshibhodi yakho eyenziwe ngokwakho...",
  },
  "Quiz": {
    English: "Quiz",
    IsiZulu: "Imibuzo",
  ...
  "Recommendations": {
    ...
    Siswati: "Tincomo",
    isiXhosa: "Iingcebiso",
    Setswana: "Dikgothatso",
    Sepedi: "Dikeletšo",
    Sesotho: "Litlhahiso",
    Xitsonga: "Swiletelo",
    Tshivenḓa: "Zwine zwa anelwa",
    Afrikaans: "Aanbevelings",
    IsiNdebele: "Izincomo",
  },
  "Next question": {
    English: "Next question",
    IsiZulu: "Umbuzo olandelayo",
    Siswati: "Umbuto lolandzelako",
    isiXhosa: "Umbuzo olandelayo",
    Setswana: "Potso e latelang",
    Sepedi: "Potšišo ye e latelago",
    Sesotho: "Potso e latelang",
    Xitsonga: "Xivutiso lexi landzelaka",
    Tshivenḓa: "Mbvuzo u tevhelaho",
    Afrikaans: "Volgende vraag",
    IsiNdebele: "Umbuzo olandelayo",
  },
  "Congratulations! You completed the quiz!": {
    English: "Congratulations! You completed the quiz!",
    IsiZulu: "Halala! Uqede imibuzo!",
    Siswati: "Halala! Sewuqedile imibuto!",
    isiXhosa: "Halala! Ugqibe imibuzo!",
    Setswana: "Dumela! O feditse dipotso!",
    Sepedi: "Mahlogonolo! O feditše dipotso!",
    Sesotho: "Kea leboha! U qetile lipotso!",
    Xitsonga: "Inkomu! U hetile swivutiso!",
    Tshivenḓa: "Ndo livhuwa! No fhedza mibvuzo!",
    Afrikaans: "Baie geluk! Jy het die vraelys voltooi!",
    IsiNdebele: "Halala! Uqede imibuzo!",
  },
};

export const sampleInputsTranslations = {
  "Brainstorm podcast episode ideas": {
    English: "Brainstorm podcast episode ideas",
    IsiZulu: "Cabanga ngemibono yeziqephu zepodcast",
    Siswati: "Cabanga ngetincomo tetihloko tepodcast",
    isiXhosa: "Cinga ngezimvo zeziqephu zepodcast",
    Setswana: "Akanya ka dikakanyo tsa dipodcaster episode",
    Sepedi: "Naganišiša ka dikgopolo tša di-episode tša podcast",
    Sesotho: "Nahana ka mehopolo ea likhaolo tsa podcast",
    Xitsonga: "Tirhisa mianakanyo ya swiphemu swa podcast",
    Tshivenḓa: "Pfunzo dza zwiphemu zwa podcast",
    Afrikaans: "Dink oor podcast-episode-idees",
    IsiNdebele: "Cabanga ngemibono yeziqephu zepodcast",
  },
  "Explain this code": {
    English: "Explain this code",
    IsiZulu: "Chaza le khodi",
    Siswati: "Chaza lekhodi",
    isiXhosa: "Cacisa le khowudi",
    Setswana: "Tlhalosa khoutu e",
    Sepedi: "Hlatholla khoutu ye",
    Sesotho: "Hlalosa khoutu ena",
    Xitsonga: "Hlamusela khodi leyi",
    Tshivenḓa: "Tshimbidzanani na khodi iyi",
    Afrikaans: "Verduidelik hierdie kode",
    IsiNdebele: "Chaza le khodi",
  },
  "Help me improve this job description": {
    English: "Help me improve this job description",
    IsiZulu: "Ngisize ngithuthukise incazelo yomsebenzi",
    Siswati: "Ngisite ngitfutfukise incazelo yemsebenti",
    isiXhosa: "Ndincele ukuphucula inkcazo yomsebenzi",
    Setswana: "Nthuse go tokafatsa tlhaloso ya tiro e",
    Sepedi: "Nthute go kaonafatša tlhaloso ya mošomo wo",
    Sesotho: "Nthuse ho ntlafatsa tlhaloso ena ea mosebetsi",
    Xitsonga: "Ndzi pfuna ku antswisa nhlamuselo ya ntirho lowu",
    Tshivenḓa: "Nnditshile u khwinisa tsumbo ya mushumo uyu",
    Afrikaans: "Help my om hierdie posbeskrywing te verbeter",
    IsiNdebele: "Ngisize ngithuthukise incazelo yomsebenzi",
  },
  "Teach me to negotiate": {
    English: "Teach me to negotiate",
    IsiZulu: "Ngifundise ukuxoxisana",
    Siswati: "Ngifundzise kutsenga",
    isiXhosa: "Ndifundise ukuxoxisana",
    Setswana: "Nthute go buisana",
    Sepedi: "Nthute go negošiata",
    Sesotho: "Nthute ho buisana",
    Xitsonga: "Ndzi dyondzisa ku pfumelelana",
    Tshivenḓa: "Ndi funza u pfumelelana",
    Afrikaans: "Leer my om te onderhandel",
    IsiNdebele: "Ngifundise ukuxoxisana",
  },
  "Design a database schema": {
    English: "Design a database schema",
    IsiZulu: "Dizayina isikimu sedatha",
    Siswati: "Dizayina schema yedatha",
    isiXhosa: "Yila isikimu sedatha",
    Setswana: "Dira schema ya data",
    Sepedi: "Rulaganya schema ya data",
    Sesotho: "Rala schema ea database",
    Xitsonga: "Endla schema ya database",
    Tshivenḓa: "Tumbuluxa schema ya database",
    Afrikaans: "Ontwerp 'n databasis-skema",
    IsiNdebele: "Dizayina isikimu sedatha",
  },
};